...
import {featureKey, ProjectFederatedExperimentState} from './project-federated-experiments.reducer';

export const selectFeature =
  createFeatureSelector<ProjectFederatedExperimentState>(featureKey);
